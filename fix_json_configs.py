...
# Watchlist
watchlist = {"pairs": ["BTC/USDT", "ETH/USDT"], "updated_at": "2025-10-31T10:46:00Z"}
...
with open(CONFIG_DIR / "risk_config.json", "w") as f:
    json.dump(risk, f, indent=2)

# Paper wallet
wallet = {"balance_usdt": 10000.0, "equity_usdt": 10000.0, "unrealized_pnl_usdt": 0.0, "realized_pnl_usdt": 0.0, "updated_at": "2025-10-31T10:46:00Z"}
with open(CONFIG_DIR / "paper_wallet.json", "w") as f:
    json.dump(wallet, f, indent=2)

print("✅ Configs JSON fixes")
